...
## Версия 0.1.1
- [x] Актуализировать и детализировать документацию
- [x] Улучшить удобство и надежность клиентского приложения
- [x] Проверка завершения времени тестирования
- [x] Улучшить удобство первичного запуска и настройки


## Версия 0.1.2
- [ ] Code review серверного приложения
- [x] Изменить аргументы серверного приложения в соответствии с документацией
- [x] Выставление прав доступа на директории сервера
...
3. Права доступа директорий задаются равными 750, файлов - 640.
...
2. Парсинг тестов, указанных в настройках из markdown файлов в дирректории `/opt/learned-cat/tests/` (или другой, указанной в настройках).
3. Чтение файлов ответов из дирректирии `/opt/learned-cat/results` (или другой, указанной в настройках).
