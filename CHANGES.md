...
- [ ] Добавлена команда learned-cat-daemon status, выводящая статистическую информацию и текущее количество активных пользователей.
- [ ] Добавлена команда learned-cat-daemon reload и соответствующая команда systemctl reload learned-cat-daemon для повторного чтения настроек.
...
- [ ] Добавлена опция --best для команд learned-cat-daemon export-marks, выводящая информацию только о результатах с максимальным баллом. 
